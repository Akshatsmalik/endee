# ragly — Intelligent Document Q&A with Endee Vector Database
...
**ragly** solves this by combining:
...
├── docs/
│   └── architecture.md
├── docker-compose.yml         # Full stack: Endee + ragly API
├── Dockerfile
├── requirements.txt
├── .env.example
└── README.md
...
git clone https://github.com/YOUR_USERNAME/ragly-endee.git
cd ragly-endee
